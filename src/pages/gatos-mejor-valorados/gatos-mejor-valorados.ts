...
@IonicPage()
@Component({
  selector: 'page-gatos-mejor-valorados',
  templateUrl: 'gatos-mejor-valorados.html',
})
export class GatosMejorValoradosPage {
  ...
  ionViewWillEnter() {
    this._mgato.top10mejorValorados().then((gatos) => {
      this.gatos = gatos;
    });
  }
